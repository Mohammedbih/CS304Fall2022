...
//center the JFrame on the screen
  ...
  /**
   * Implementation of our ActionListener. This allows the buttons to perform an action. In this
   * case they set the "whatToDraw" String and ask for a repaint of the GLCanvas.
   */
